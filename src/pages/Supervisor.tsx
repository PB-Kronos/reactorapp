...
export default function Supervisor() {
  ...
  const createInvite = (unit: 1 | 2, customStation?: string) => {
    const station = (customStation || createStationId(unit)).toUpperCase().replace(/[^A-Z0-9-]/g, "").slice(0, 32) || createStationId(unit);
